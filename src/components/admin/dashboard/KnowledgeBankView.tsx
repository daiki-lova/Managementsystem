...
import type { KnowledgeItem, Profile } from '@/app/admin/lib/types';
import { format } from 'date-fns';
import { ja } from 'date-fns/locale';
import { useKnowledgeBank, useCreateKnowledgeEntry, useDeleteKnowledgeEntry, useUpdateKnowledgeEntry, useAuthors } from '@/app/admin/lib/hooks';
