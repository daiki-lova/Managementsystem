...
import { useMedia, useUploadMedia, useDeleteMedia, useGenerateMedia } from '@/app/admin/lib/hooks';
...
export function MediaLibraryView() {
    ...
    const media: MediaItem[] = (mediaData?.data || []).map((item: any) => ({
        id: item.id,
        url: item.url,
        name: item.filename || item.originalFilename || 'Untitled',
        type: item.mimeType,
    ...
    const handleMoveToFolder = (itemId: string, folderId: string) => {
        // TODO: Implement move to folder API
        console.log('Move to folder not yet implemented:', itemId, folderId);
